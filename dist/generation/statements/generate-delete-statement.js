...
exports.generateFilteredDelete = generateFilteredDelete;
...
function generateDeleteStatement(tableName) {
  return ["DELETE ".concat((0, _generateFrom.generateFrom)(false)(tableName)), []];
}

function generateFilteredDelete(tableName) {
  return function (predicate) {
    ...
    var fragments = [deleteSql, whereSql];
    var sql = (0, _standardFunctions.joinWithNewline)(fragments);
